...
// const PoseNLP = ({ currentPose, poseKeypoints, confidenceScore }) => {
...
//     analyzePose(currentPose, poseKeypoints, confidenceScore);
//   }, [currentPose, poseKeypoints, confidenceScore]);

//   const analyzePose = (pose, keypoints, confidence) => {
//     setFeedback('');
//     setCorrections([]);
...
//     if (confidence < 0.4) {
//       setFeedback("I'm having trouble seeing your pose clearly. Please adjust your position.");
//       return;
//     } else if (confidence < 0.6) {
//       setFeedback("Getting better! Let's work on perfecting your form.");
//     } else {
//       setFeedback("Great effort! Keep holding the pose steady.");
//     }
...
//     setInstructions(getPoseInstructions(pose));
//   };

//   // Analyze common posture issues across poses
...
//     // Check if shoulders are level (using a wider threshold due to model inaccuracy)
//     if (Math.abs(leftShoulder.y - rightShoulder.y) > 20) {
//       corrections.push("Try to keep your shoulders level");
//     }
    
//     // Check if hips are level
//     if (Math.abs(leftHip.y - rightHip.y) > 20) {
//       corrections.push("Balance your hips evenly");
//     }
    
//     // Check if neck is aligned properly
//     const midShouldersX = (leftShoulder.x + rightShoulder.x) / 2;
//     if (Math.abs(nose.x - midShouldersX) > 30) {
//       corrections.push("Align your head over your spine");
//     }
//   };

//   // Individual pose analysis functions
...
//     const normalizedPose = pose.replace('_', ' ');
...
//         "Draw your abdomen in slightly",
//         "Broaden your chest and roll your shoulders back",
//         "Let your arms hang naturally by your sides",
//         "Hold your head straight with gaze forward"
//       ],
//       'Sukhasana': [
...
//     return poseGuide[normalizedPose] || ["Center yourself in the frame", "Follow the reference image"];
//   };
...
//         <h4>Feedback:</h4>
//         <p className="primary-feedback">{feedback || "Waiting for pose detection..."}</p>
...
//           </ol>
//         ) : (
//           <p>Select a pose to see instructions</p>
//         )}
//       </div>
//     </div>
//   );
...
const PoseNLP = ({ currentPose, poseKeypoints, confidenceScore }) => {
  ...
  // Load base instructions immediately when pose changes
  useEffect(() => {
  ...
  const getPoseInstructions = (pose) => {
    ...
    return poseGuide[pose] || ["Center yourself in the frame", "Follow the reference image"];
  };
